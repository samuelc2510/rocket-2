...
def on_on_overlap2(sprite2, otherSprite2):
    ...
    ship.destroy(effects.spray, 500)
    abilitt.destroy(effects.spray, 500)
    info.change_score_by(10)
sprites.on_overlap(SpriteKind.abilit, SpriteKind.enemy, on_on_overlap2)
...
def on_a_released():
    ...
    abilitt = sprites.create(img("""
        ...
        """),
        SpriteKind.abilit)
    abilitt.set_position(37, 53)
    pause(100)
    abilitt.follow(ship, 100)
    abilitt.set_flag(SpriteFlag.AUTO_DESTROY, True)
    pause(5000)
...
megalodon = sprites.create(img("""
    ...
    """),
    SpriteKind.player)
controller.move_sprite(megalodon, 100, 100)
megalodon.set_stay_in_screen(True)
info.set_life(100)
...
def on_on_update():
    ...
    projectile2 = sprites.create(img("""
        ...
        """),
        SpriteKind.player)
    projectile2.follow(megalodon, 100)
...
def on_update_interval():
    ...
    ship = sprites.create(img("""
        ...
        """),
        SpriteKind.enemy)
    ship.set_position(150, 45)
    ship.set_velocity(-13, 0)
    ship.set_flag(SpriteFlag.AUTO_DESTROY, True)
